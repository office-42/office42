...
| | `o42-eval.c` | 15,724 | 605 functions and the array evaluator | Far too big for one file. The function table is sorted and binary-searched, which is right, but the file should be several: text, dates, money, statistics, engineering, the array frame |
...
| Formulas and functions | 15 | 100% | 15.0 | every Excel 2003 function is here (605 in all) |
...
| Formulas and functions | 18 | 96% | 17.3 | 605 of ~650 functions; five options that want the bivariate normal, and Miltersen and Schwartz |
