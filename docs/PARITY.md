...
| | `o42-eval.c` | 14,847 | 589 functions and the array evaluator | Far too big for one file. The function table is sorted and binary-searched, which is right, but the file should be several: text, dates, money, statistics, engineering, the array frame |
...
| Formulas and functions | 15 | 100% | 15.0 | every Excel 2003 function is here (589 in all) |
...
| Formulas and functions | 18 | 91% | 16.4 | 589 of ~650 functions; the exotic options (Black and Scholes is here) |
