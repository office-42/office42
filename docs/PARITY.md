...
| | `o42-eval.c` | 15,104 | 592 functions and the array evaluator | Far too big for one file. The function table is sorted and binary-searched, which is right, but the file should be several: text, dates, money, statistics, engineering, the array frame |
...
| Formulas and functions | 15 | 100% | 15.0 | every Excel 2003 function is here (592 in all) |
...
| Formulas and functions | 18 | 92% | 16.6 | 592 of ~650 functions; the exotic options (Black and Scholes is here) |
