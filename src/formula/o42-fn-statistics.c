...
const O42FunctionHelp O42_HELP_STATISTICS[] = {
  { "AVEDEV", "AVEDEV(number1, number2, ...)", N_("The average absolute deviation from the mean.") },
  { "CORREL", "CORREL(array1, array2)", N_("The correlation coefficient of two sets.") },
  { "COVAR", "COVAR(array1, array2)", N_("The population covariance of two sets.") },
  { "COVARIANCE.P", "COVARIANCE.P(array1, array2)", N_("The population covariance.") },
  { "DEVSQ", "DEVSQ(number1, number2, ...)", N_("The sum of squared deviations from the mean.") },
  { "FORECAST", "FORECAST(x, known_y's, known_x's)", N_("A value on the regression line through known points.") },
  { "FORECAST.LINEAR", "FORECAST.LINEAR(x, known_ys, known_xs)", N_("A value on the regression line through the points.") },
  { "GEOMEAN", "GEOMEAN(number1, number2, ...)", N_("The geometric mean.") },
  { "HARMEAN", "HARMEAN(number1, number2, ...)", N_("The harmonic mean.") },
  { "INTERCEPT", "INTERCEPT(known_y's, known_x's)", N_("Where the regression line crosses the y axis.") },
  { "LARGE", "LARGE(range, k)", N_("The k-th largest value.") },
  { "MODE", "MODE(number1, number2, ...)", N_("The most frequent value.") },
  { "MODE.SNGL", "MODE.SNGL(number1, number2, ...)", N_("The most frequent value.") },
  { "NORM.DIST", "NORM.DIST(x, mean, standard_dev, cumulative)", N_("The normal distribution.") },
  { "NORM.INV", "NORM.INV(probability, mean, standard_dev)", N_("The inverse of the cumulative normal distribution.") },
  { "NORM.S.INV", "NORM.S.INV(probability)", N_("The inverse of the standard normal distribution.") },
  { "NORMDIST", "NORMDIST(x, mean, standard_dev, cumulative)", N_("The normal distribution.") },
  { "NORMINV", "NORMINV(probability, mean, standard_dev)", N_("The inverse of the normal distribution.") },
  { "NORMSDIST", "NORMSDIST(z)", N_("The standard normal cumulative distribution.") },
  { "NORMSINV", "NORMSINV(probability)", N_("The inverse of the standard normal distribution.") },
  { "PEARSON", "PEARSON(array1, array2)", N_("The Pearson correlation coefficient.") },
  { "PERCENTILE", "PERCENTILE(range, k)", N_("The value below which a fraction k of the values lie.") },
  { "PERCENTILE.INC", "PERCENTILE.INC(array, k)", N_("The k-th percentile, inclusive.") },
  { "QUARTILE", "QUARTILE(range, quart)", N_("A quartile of the values: 0 to 4.") },
  { "QUARTILE.INC", "QUARTILE.INC(array, quart)", N_("A quartile, inclusive.") },
  { "RANK", "RANK(number, range, order)", N_("The rank of a number among others.") },
  { "RANK.EQ", "RANK.EQ(number, ref, order)", N_("The rank of a number in a list.") },
  { "RSQ", "RSQ(known_y's, known_x's)", N_("The square of the correlation coefficient.") },
  { "SLOPE", "SLOPE(known_y's, known_x's)", N_("The slope of the regression line.") },
  { "SMALL", "SMALL(range, k)", N_("The k-th smallest value.") },
  { "STANDARDIZE", "STANDARDIZE(x, mean, standard_dev)", N_("A value as a number of standard deviations from the mean.") },
  { "STDEV", "STDEV(number1, number2, ...)", N_("The standard deviation of a sample.") },
  { "STDEV.P", "STDEV.P(number1, number2, ...)", N_("The population standard deviation.") },
  { "STDEV.S", "STDEV.S(number1, number2, ...)", N_("The sample standard deviation.") },
  { "STDEVP", "STDEVP(number1, number2, ...)", N_("The standard deviation of a whole population.") },
  { "VAR", "VAR(number1, number2, ...)", N_("The variance of a sample.") },
  { "VAR.P", "VAR.P(number1, number2, ...)", N_("The population variance.") },
  { "VAR.S", "VAR.S(number1, number2, ...)", N_("The sample variance.") },
  { "VARP", "VARP(number1, number2, ...)", N_("The variance of a whole population.") },
  { NULL, NULL, NULL }
};
