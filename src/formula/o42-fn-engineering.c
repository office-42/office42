...
const O42FunctionHelp O42_HELP_ENGINEERING[] = {
  { "BIN2DEC", "BIN2DEC(number)", N_("A binary number as decimal.") },
  { "BIN2HEX", "BIN2HEX(number, places)", N_("A binary number as hexadecimal.") },
  { "BIN2OCT", "BIN2OCT(number, places)", N_("A binary number as octal.") },
  { "BITAND", "BITAND(number1, number2)", N_("Bitwise AND of two numbers.") },
  { "BITLSHIFT", "BITLSHIFT(number, shift_amount)", N_("A number shifted left by some bits.") },
  { "BITOR", "BITOR(number1, number2)", N_("Bitwise OR of two numbers.") },
  { "BITRSHIFT", "BITRSHIFT(number, shift_amount)", N_("A number shifted right by some bits.") },
  { "BITXOR", "BITXOR(number1, number2)", N_("Bitwise exclusive OR of two numbers.") },
  { "COMPLEX", "COMPLEX(real_num, i_num, suffix)", N_("A complex number as text, like 3+4i.") },
  { "DEC2BIN", "DEC2BIN(number, places)", N_("A decimal number as binary.") },
  { "DEC2HEX", "DEC2HEX(number, places)", N_("A decimal number as hexadecimal.") },
  { "DEC2OCT", "DEC2OCT(number, places)", N_("A decimal number as octal.") },
  { "DELTA", "DELTA(number1, number2)", N_("1 if the two numbers are equal, else 0.") },
  { "ERF", "ERF(lower_limit, upper_limit)", N_("The error function between two limits.") },
  { "ERF.PRECISE", "ERF.PRECISE(x)", N_("The error function.") },
  { "ERFC", "ERFC(x)", N_("The complementary error function.") },
  { "ERFC.PRECISE", "ERFC.PRECISE(x)", N_("The complementary error function.") },
  { "GESTEP", "GESTEP(number, step)", N_("1 if the number is at least the step, else 0.") },
  { "HEX2BIN", "HEX2BIN(number, places)", N_("A hexadecimal number as binary.") },
  { "HEX2DEC", "HEX2DEC(number)", N_("A hexadecimal number as decimal.") },
  { "HEX2OCT", "HEX2OCT(number, places)", N_("A hexadecimal number as octal.") },
  { "IMABS", "IMABS(inumber)", N_("The modulus of a complex number.") },
  { "IMAGINARY", "IMAGINARY(inumber)", N_("The imaginary part of a complex number.") },
  { "IMARGUMENT", "IMARGUMENT(inumber)", N_("The argument of a complex number, in radians.") },
  { "IMCONJUGATE", "IMCONJUGATE(inumber)", N_("The conjugate of a complex number.") },
  { "IMCOS", "IMCOS(inumber)", N_("The cosine of a complex number.") },
  { "IMDIV", "IMDIV(inumber1, inumber2)", N_("The quotient of two complex numbers.") },
  { "IMEXP", "IMEXP(inumber)", N_("The exponential of a complex number.") },
  { "IMLN", "IMLN(inumber)", N_("The natural logarithm of a complex number.") },
  { "IMLOG10", "IMLOG10(inumber)", N_("The base-10 logarithm of a complex number.") },
  { "IMLOG2", "IMLOG2(inumber)", N_("The base-2 logarithm of a complex number.") },
  { "IMPOWER", "IMPOWER(inumber, number)", N_("A complex number raised to a power.") },
  { "IMPRODUCT", "IMPRODUCT(inumber1, inumber2, ...)", N_("The product of complex numbers.") },
  { "IMREAL", "IMREAL(inumber)", N_("The real part of a complex number.") },
  { "IMSIN", "IMSIN(inumber)", N_("The sine of a complex number.") },
  { "IMSQRT", "IMSQRT(inumber)", N_("The square root of a complex number.") },
  { "IMSUB", "IMSUB(inumber1, inumber2)", N_("The difference of two complex numbers.") },
  { "IMSUM", "IMSUM(inumber1, inumber2, ...)", N_("The sum of complex numbers.") },
  { "OCT2BIN", "OCT2BIN(number, places)", N_("An octal number as binary.") },
  { "OCT2DEC", "OCT2DEC(number)", N_("An octal number as decimal.") },
  { "OCT2HEX", "OCT2HEX(number, places)", N_("An octal number as hexadecimal.") },
  { NULL, NULL, NULL }
};
