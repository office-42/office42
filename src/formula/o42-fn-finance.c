...
const O42FunctionHelp O42_HELP_FINANCE[] = {
  { "ACCRINT", "ACCRINT(issue, first_interest, settlement, rate, par, frequency, basis, method)", N_("Accrued interest on a security that pays periodically.") },
  { "ACCRINTM", "ACCRINTM(issue, settlement, rate, par, basis)", N_("Accrued interest on a security that pays at maturity.") },
  { "AMORDEGRC", "AMORDEGRC(cost, purchased, first_period, salvage, period, rate, basis)", N_("French degressive depreciation for a period.") },
  { "AMORLINC", "AMORLINC(cost, purchased, first_period, salvage, period, rate, basis)", N_("French straight-line depreciation for a period.") },
  { "BAHTTEXT", "BAHTTEXT(number)", N_("A number written out in Thai, in baht and satang.") },
  { "COUPDAYBS", "COUPDAYBS(settlement, maturity, frequency, basis)", N_("Days from the start of the coupon period to the settlement.") },
  { "COUPDAYS", "COUPDAYS(settlement, maturity, frequency, basis)", N_("Days in the coupon period the settlement falls in.") },
  { "COUPDAYSNC", "COUPDAYSNC(settlement, maturity, frequency, basis)", N_("Days from the settlement to the next coupon.") },
  { "COUPNCD", "COUPNCD(settlement, maturity, frequency, basis)", N_("The next coupon date after the settlement.") },
  { "COUPNUM", "COUPNUM(settlement, maturity, frequency, basis)", N_("How many coupons are payable between settlement and maturity.") },
  { "COUPPCD", "COUPPCD(settlement, maturity, frequency, basis)", N_("The coupon date on or before the settlement.") },
  { "DATEDIF", "DATEDIF(start_date, end_date, unit)", N_("The time between two dates in years, months or days: \"Y\", \"M\", \"D\", \"YM\", \"YD\", \"MD\".") },
  { "DISC", "DISC(settlement, maturity, pr, redemption, basis)", N_("The discount rate of a security.") },
  { "DURATION", "DURATION(settlement, maturity, coupon, yld, frequency, basis)", N_("A bond's Macaulay duration in years.") },
  { "EUROCONVERT", "EUROCONVERT(number, source, target, full_precision, triangulation_precision)", N_("A sum in one of the euro's member currencies (ISO code) as another, at the fixed rates.") },
  { "FVSCHEDULE", "FVSCHEDULE(principal, schedule)", N_("A principal grown by a series of interest rates.") },
  { "INTRATE", "INTRATE(settlement, maturity, investment, redemption, basis)", N_("The interest rate of a fully invested security.") },
  { "ISOWEEKNUM", "ISOWEEKNUM(serial)", N_("The ISO week number of a date.") },
  { "MDURATION", "MDURATION(settlement, maturity, coupon, yld, frequency, basis)", N_("A bond's modified duration.") },
  { "ODDFPRICE", "ODDFPRICE(settlement, maturity, issue, first_coupon, rate, yld, redemption, frequency, basis)", N_("The price of a bond with an odd first period.") },
  { "ODDFYIELD", "ODDFYIELD(settlement, maturity, issue, first_coupon, rate, pr, redemption, frequency, basis)", N_("The yield of a bond with an odd first period.") },
  { "ODDLPRICE", "ODDLPRICE(settlement, maturity, last_interest, rate, yld, redemption, frequency, basis)", N_("The price of a bond with an odd last period.") },
  { "ODDLYIELD", "ODDLYIELD(settlement, maturity, last_interest, rate, pr, redemption, frequency, basis)", N_("The yield of a bond with an odd last period.") },
  { "PHONETIC", "PHONETIC(reference)", N_("The furigana in a cell; the text itself here.") },
  { "PRICE", "PRICE(settlement, maturity, rate, yld, redemption, frequency, basis)", N_("The price per 100 of a bond paying periodic interest.") },
  { "PRICEDISC", "PRICEDISC(settlement, maturity, discount, redemption, basis)", N_("The price per 100 of a discounted security.") },
  { "PRICEMAT", "PRICEMAT(settlement, maturity, issue, rate, yld, basis)", N_("The price per 100 of a security paying at maturity.") },
  { "RECEIVED", "RECEIVED(settlement, maturity, investment, discount, basis)", N_("What a fully invested security pays at maturity.") },
  { "TBILLEQ", "TBILLEQ(settlement, maturity, discount)", N_("A Treasury bill's bond-equivalent yield.") },
  { "TBILLPRICE", "TBILLPRICE(settlement, maturity, discount)", N_("The price per 100 of a Treasury bill.") },
  { "TBILLYIELD", "TBILLYIELD(settlement, maturity, pr)", N_("A Treasury bill's yield.") },
  { "WEEKNUM", "WEEKNUM(serial, return_type)", N_("The week of the year a date falls in.") },
  { "YEARFRAC", "YEARFRAC(start_date, end_date, basis)", N_("The fraction of a year between two dates.") },
  { "YIELD", "YIELD(settlement, maturity, rate, pr, redemption, frequency, basis)", N_("The yield of a bond paying periodic interest.") },
  { "YIELDDISC", "YIELDDISC(settlement, maturity, pr, redemption, basis)", N_("The annual yield of a discounted security.") },
  { "YIELDMAT", "YIELDMAT(settlement, maturity, issue, rate, pr, basis)", N_("The yield of a security paying at maturity.") },
  { NULL, NULL, NULL }
};
