...
const O42FunctionHelp O42_HELP_DISTRIBUTIONS[] = {
  { "BETA.INV", "BETA.INV(probability, alpha, beta, A, B)", N_("The inverse of the cumulative beta distribution.") },
  { "BETADIST", "BETADIST(x, alpha, beta, A, B)", N_("The cumulative beta distribution.") },
  { "BETAINV", "BETAINV(probability, alpha, beta, A, B)", N_("The inverse of the cumulative beta distribution.") },
  { "BINOM.DIST", "BINOM.DIST(number_s, trials, probability_s, cumulative)", N_("The binomial distribution.") },
  { "BINOMDIST", "BINOMDIST(successes, trials, probability, cumulative)", N_("The binomial distribution.") },
  { "CHIDIST", "CHIDIST(x, degrees_freedom)", N_("The right tail of the chi-squared distribution.") },
  { "CHIINV", "CHIINV(probability, degrees_freedom)", N_("The inverse of the right-tailed chi-squared distribution.") },
  { "CHISQ.DIST.RT", "CHISQ.DIST.RT(x, deg_freedom)", N_("The right tail of the chi-squared distribution.") },
  { "CHISQ.INV.RT", "CHISQ.INV.RT(probability, deg_freedom)", N_("The inverse of the right-tailed chi-squared distribution.") },
  { "CONFIDENCE", "CONFIDENCE(alpha, standard_dev, size)", N_("The half-width of a confidence interval for a mean.") },
  { "CONFIDENCE.NORM", "CONFIDENCE.NORM(alpha, standard_dev, size)", N_("Half the width of a confidence interval for a mean.") },
  { "EXPON.DIST", "EXPON.DIST(x, lambda, cumulative)", N_("The exponential distribution.") },
  { "EXPONDIST", "EXPONDIST(x, lambda, cumulative)", N_("The exponential distribution.") },
  { "F.DIST.RT", "F.DIST.RT(x, deg_freedom1, deg_freedom2)", N_("The right tail of the F distribution.") },
  { "F.INV.RT", "F.INV.RT(probability, deg_freedom1, deg_freedom2)", N_("The inverse of the right-tailed F distribution.") },
  { "FDIST", "FDIST(x, degrees_freedom1, degrees_freedom2)", N_("The right tail of the F distribution.") },
  { "FINV", "FINV(probability, degrees_freedom1, degrees_freedom2)", N_("The inverse of the right-tailed F distribution.") },
  { "GAMMA.DIST", "GAMMA.DIST(x, alpha, beta, cumulative)", N_("The gamma distribution.") },
  { "GAMMA.INV", "GAMMA.INV(probability, alpha, beta)", N_("The inverse of the cumulative gamma distribution.") },
  { "GAMMADIST", "GAMMADIST(x, alpha, beta, cumulative)", N_("The gamma distribution.") },
  { "GAMMAINV", "GAMMAINV(probability, alpha, beta)", N_("The inverse of the cumulative gamma distribution.") },
  { "GAMMALN", "GAMMALN(x)", N_("The natural logarithm of the gamma function.") },
  { "GAMMALN.PRECISE", "GAMMALN.PRECISE(x)", N_("The natural logarithm of the gamma function.") },
  { "KURT", "KURT(number1, number2, ...)", N_("The kurtosis of a sample.") },
  { "LOGNORMDIST", "LOGNORMDIST(x, mean, standard_dev)", N_("The cumulative lognormal distribution.") },
  { "POISSON", "POISSON(x, mean, cumulative)", N_("The Poisson distribution.") },
  { "POISSON.DIST", "POISSON.DIST(x, mean, cumulative)", N_("The Poisson distribution.") },
  { "SKEW", "SKEW(number1, number2, ...)", N_("The skewness of a sample.") },
  { "T.INV.2T", "T.INV.2T(probability, deg_freedom)", N_("The inverse of the two-tailed t distribution.") },
  { "TDIST", "TDIST(x, degrees_freedom, tails)", N_("The tail of Student's t distribution, one or both.") },
  { "TINV", "TINV(probability, degrees_freedom)", N_("The two-tailed inverse of Student's t distribution.") },
  { "TRIMMEAN", "TRIMMEAN(range, percent)", N_("The mean with a fraction of the extremes left out.") },
  { "WEIBULL", "WEIBULL(x, alpha, beta, cumulative)", N_("The Weibull distribution.") },
  { "WEIBULL.DIST", "WEIBULL.DIST(x, alpha, beta, cumulative)", N_("The Weibull distribution.") },
  { NULL, NULL, NULL }
};
