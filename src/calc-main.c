  ...
  if (argc > 1 && (strcmp (argv[1], "--help") == 0 || strcmp (argv[1], "-h") == 0))
    {
      printf ("usage: office42-calc [--functions | --help | --version] < SCRIPT\n"
              ...
              "\n"
              "Cells     copy paste filldown fillright fillup fillleft series justify autofill\n"
              ...
              "Sheets    sheet rename delsheet copysheet freeze split hiderows unhiderows hidecols\n"
              "          unhidecols\n"
              ...
              "Other     undo redo name names unname createnames applynames prop props spell view\n"
